        ...
        try:
            ...
            for i in range(self.game_batch_num):
                ...
                if (i+1) % self.check_freq == 0:
                    ...
                    print("Current win rate: ", win_ratio)
                    self.policy_value_net.save_model(f'./{self.board_height}x{self.board_width}/current_policy.model')
                    if win_ratio > self.best_win_ratio:
                        print("New best policy!!!!!!!!")
                        self.best_win_ratio = win_ratio
                        # update the best_policy
                        self.policy_value_net.save_model(f'./{self.board_height}x{self.board_width}/best_policy.model')
